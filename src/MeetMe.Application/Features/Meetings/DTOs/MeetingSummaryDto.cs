...
{
    /// <summary>
    /// Lightweight meeting DTO for cross-feature references and list views
    /// </summary>
    public record MeetingSummaryDto : IMapFrom<Meeting>
    {
        ...
        {
            profile.CreateMap<Meeting, MeetingSummaryDto>()
