...
public class CreatePostCommandHandlerTests
{
    ...
    public async Task Handle_WithValidRequest_ShouldReturnSuccessResult()
    {
        ...
        _mockPostCommandRepository
            .Setup(x => x.AddAsync(It.IsAny<Post>(), It.IsAny<int>(), It.IsAny<CancellationToken>()))
        ...
        _mockPostCommandRepository.Verify(
            x => x.AddAsync(It.IsAny<Post>(), authorId, It.IsAny<CancellationToken>()),
            Times.Once);

        _mockUnitOfWork.Verify(
            x => x.SaveChangesAsync(authorId, It.IsAny<CancellationToken>()),
            Times.Once);
    }
    ...
    public async Task Handle_WithNonExistentAuthor_ShouldReturnFailureResult()
    {
        ...
        _mockPostCommandRepository.Verify(
            x => x.AddAsync(It.IsAny<Post>(), It.IsAny<int>(), It.IsAny<CancellationToken>()),
            Times.Never);
